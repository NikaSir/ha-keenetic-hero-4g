...
**Release candidate:** UI 1.0.10 / integration 1.0.0-b064
...
| Version coherence | PASS | Visible UI, runtime/cache key, asset URLs, contract, panel manifest and integration metadata agree on UI 1.0.10 / b064. |
