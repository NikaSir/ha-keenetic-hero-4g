...
class PanelRules117RebuildTests(unittest.TestCase):
    ...
    def test_rule_117_rebuild_versions_are_synchronized(self) -> None:
        self.assertEqual(self.contract["panel"]["version"], "0.8.5")
        self.assertEqual(self.contract["app_shell"]["version"], "1.8")
        self.assertEqual(self.panel_manifest["panel_version"], "0.8.5")
        self.assertEqual(self.panel_manifest["zoom_policy"]["standard"], "1.8")
        self.assertEqual(self.integration_manifest["version"], "1.0.0-b047")
    ...
    def test_production_bundle_contains_the_current_component_without_imports(self) -> None:
        ...
        self.assertIn('customElements.define("keenetic-hero-app-panel-v085"', self.bundle)
        self.assertNotIn('await import("./keenetic-app-v084.js")', self.bundle)
        self.assertEqual(self.panel_manifest["web_component"], "keenetic-hero-app-panel-v085")
        self.assertEqual(
            self.contract["frontend_delivery"]["web_component"],
            "keenetic-hero-app-panel-v085",
        )
