...
class PanelRouterBaselineV100Tests(unittest.TestCase):
    ...
    def test_approved_router_is_a_versioned_local_layer(self) -> None:
        ...
        self.assertIn("keenetic-hero-router-v086.webp?v=1.0.12", self.source)
        router = next(
        ...
        self.assertEqual(
            router["url"],
            "/keenetic_hero_4g_static/assets/keenetic-hero-router-v086.webp?v=1.0.12",
        )
    ...
    def test_router_asset_is_static_and_not_rewritten_by_telemetry_patch(self) -> None:
        self.assertEqual(self.source.count("keenetic-hero-router-v086.webp?v=1.0.12"), 1)
