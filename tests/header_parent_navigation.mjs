...
const shell = fs.readFileSync("custom_components/keenetic_hero_4g/frontend/nikas-specialized-shell.js", "utf8");
for (const source of ["/dashboard-actions/home", "/dashboard-rooms-v11/rooms", "/dashboard-infrastructure/overview"]) {
 ...
 assert.equal(vm.runInContext('captureNikasShellReturnRoute({panelId:"keenetic_hero_4g",parentRoute:"/home/overview",safeReturnRoute:"/home/overview"})', context), "/home/overview");
}
