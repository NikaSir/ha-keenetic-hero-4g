...
class PanelShellV22Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.profile = json.loads((ROOT / ".nikas-ui-standard.json").read_text(encoding="utf-8"))
        cls.source_kit = (FRONTEND / "nikas-specialized-shell.js").read_text(encoding="utf-8")
        cls.runtime = (FRONTEND / "keenetic-app-v100.js").read_text(encoding="utf-8")
        cls.bundle = (FRONTEND / "keenetic-panel-bundle.js").read_text(encoding="utf-8")
    ...
    def test_vendored_source_kit_is_hash_pinned_and_bundled_first(self) -> None:
        ...
        self.assertEqual(digest, "c7171560b68e2c4118b327c5e6a63c65e3410a4e1f10a02691e0d15560166e65")
        self.assertEqual(self.profile["source_kit"]["sha256"], digest)
        shell_marker = "// BEGIN custom_components/keenetic_hero_4g/frontend/nikas-specialized-shell.js"
        runtime_marker = "// BEGIN custom_components/keenetic_hero_4g/frontend/keenetic-app-v100.js"
    ...
    def test_runtime_uses_the_canonical_host_bound_shell(self) -> None:
        ...
        self.assertNotIn("100vh", self.runtime)
        self.assertNotIn("100dvh", self.runtime)
    ...
    def test_shell_rows_content_frame_and_five_tabs_match_contract(self) -> None:
        ...
        self.assertEqual(self.runtime.count("const K100_TABS = ["), 1)
    ...
    def test_host_guard_is_wired_and_cleaned_up(self) -> None:
        self.assertIn("createNikasShellScrollBoundaryGuard({host:this,viewport})", self.runtime)
        self.assertIn("this._scrollGuardCleanup?.()", self.runtime)
        self.assertIn('host.addEventListener("touchmove", moveTouch, { passive: false, capture: true })', self.source_kit)
        self.assertIn("event.touches.length !== 1", self.source_kit)

    def test_single_router_does_not_render_a_peer_selector(self) -> None:
