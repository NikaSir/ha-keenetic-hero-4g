...
// Keenetic Hero 4G+ autonomous UI 1.0.8 production bundle.
...
const KEENETIC_ROOM_V050 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v064.webp?v=1.0.8";
...
const HERO_ASSET_V051 = "/keenetic_hero_4g_static/assets/keenetic-room-v052.webp?v=1.0.8";
...
(() => {
const HERO_ASSET_V052 = "/keenetic_hero_4g_static/assets/keenetic-room-v052.webp?v=1.0.8";
...
const ROOM_ASSET_V060 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v060.svg?v=1.0.8";
const ROUTER_ASSET_V060 = "/keenetic_hero_4g_static/assets/keenetic-hero-router-v060.svg?v=1.0.8";
...
const ROOM_ASSET_V061 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v060.svg?v=1.0.8";
const ROUTER_ASSET_V061 = "/keenetic_hero_4g_static/assets/keenetic-hero-router-v060.svg?v=1.0.8";
...
const ROOM_ASSET_V062 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v062.svg?v=1.0.8";
const ROUTER_ASSET_V062 = "/keenetic_hero_4g_static/assets/keenetic-hero-router-v060.svg?v=1.0.8";
...
const ROOM_ASSET_V063 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v060.svg?v=1.0.8";
const ROUTER_ASSET_V063 = "/keenetic_hero_4g_static/assets/keenetic-hero-router-v063.webp?v=1.0.8";
...
const ROOM_ASSET_V064 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v064.webp?v=1.0.8";
...
function preloadImagesV075(root) {
  ...
  [
    "/keenetic_hero_4g_static/assets/keenetic-hero-room-v064.webp?v=1.0.8",
    "/keenetic_hero_4g_static/assets/keenetic-hero-router-v063.webp?v=1.0.8",
  ].forEach((url) => {
...
function k100Overview(panel){
  ...
  return `<section class="k100-overview">
    <article class="k100-hero">
      <div class="k100-hero-accent" aria-hidden="true"></div>
      ...
      <div class="k100-scene">
        ...
        <img class="k100-router" src="/keenetic_hero_4g_static/assets/keenetic-hero-router-v086.webp?v=1.0.8" alt="Keenetic Hero 4G+">
      </div>
    </article>
...
.k100-overview{display:grid;grid-template-rows:minmax(430px,1fr) auto auto auto;gap:8px;padding:0;min-height:100%}.k100-hero{position:relative;min-height:430px;border:1px solid var(--divider-color);border-radius:24px;overflow:hidden;isolation:isolate;background:color-mix(in srgb,var(--card-background-color) 95%,var(--primary-color) 5%);box-shadow:0 8px 26px rgba(23,45,76,.08)}
.k100-hero-accent{position:absolute;z-index:1;right:-74px;top:-86px;width:258px;height:258px;border-radius:50%;background:color-mix(in srgb,var(--primary-color) 13%,transparent);pointer-events:none}.k100-copy{position:absolute;z-index:3;left:16px;top:20px;max-width:48%}.k100-copy h1{margin:0 0 3px;font-size:25px;line-height:1.04}.k100-copy p{margin:0;font-size:14px;font-weight:650;color:var(--secondary-text-color)}
...
@media(max-width:430px){.k100-overview{grid-template-rows:minmax(350px,1fr) auto auto auto;gap:5px;padding:0}.k100-hero{min-height:350px}.k100-scene{left:10px;right:10px;bottom:10px;height:250px}.k100-copy{max-width:45%;left:13px;top:16px}.k100-copy h1{font-size:24px}.k100-indicator{right:10px;top:10px;width:154px}.k100-router{top:68%;width:40%;max-width:245px}.k100-channel{min-width:132px;padding:9px 10px}.k100-lte{top:25%}.k100-eth,.k100-lan{top:62%}.k100-reserve{padding:9px 14px}.k100-active-head{min-height:50px;padding:7px 12px}.k100-grid{grid-template-columns:repeat(3,1fr)}.k100-metric{min-height:62px;padding:7px 8px}.k100-metric strong{font-size:14px}}
@media(max-width:390px){.k100-overview{grid-template-rows:minmax(342px,1fr) auto auto auto}.k100-hero{min-height:342px}.k100-scene{height:244px}.k100-copy{max-width:44%}.k100-copy h1{font-size:22px}.k100-indicator{width:148px;padding-inline:12px}.k100-router{max-width:232px}}
`;root.append(s);}
...
</style><div id="k100-shell" class="nikas-shell"><header class="k100-header nikas-shell__header"><button id="k100-menu" class="k100-side nikas-shell__side-action" type="button" aria-label="Открыть меню Home Assistant"><ha-icon icon="mdi:menu"></ha-icon></button><button id="k100-title" class="k100-title nikas-shell__title" type="button" aria-label="Вернуться в исходную базовую панель NikaS"><strong>Keenetic Hero 4G+</strong><small>UI v1.0.8</small></button><button id="k100-refresh" class="k100-side k100-refresh nikas-shell__side-action nikas-shell__side-action--right" type="button" aria-label="Обновить"><ha-icon icon="mdi:refresh"></ha-icon></button></header><main id="k100-work" class="k100-work nikas-shell__viewport" aria-label="Рабочая область панели Keenetic"><div id="k100-stage" class="k100-stage nikas-shell__canvas nikas-shell__content"></div></main><nav id="k100-tabs" class="k100-tabs nikas-shell__tabs" style="--nikas-shell-tab-count:5" aria-label="Основные разделы"></nav><div id="k100-scale-status" class="k100-scale-status" role="status" aria-live="polite">Масштаб 100%</div></div>`;
