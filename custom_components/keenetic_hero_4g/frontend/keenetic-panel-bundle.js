...
// Keenetic Hero 4G+ autonomous UI 1.0.14 production bundle.
...
const KEENETIC_ROOM_V050 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v064.webp?v=1.0.14";
...
const HERO_ASSET_V051 = "/keenetic_hero_4g_static/assets/keenetic-room-v052.webp?v=1.0.14";
...
(() => {
const HERO_ASSET_V052 = "/keenetic_hero_4g_static/assets/keenetic-room-v052.webp?v=1.0.14";
...
const ROOM_ASSET_V060 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v060.svg?v=1.0.14";
const ROUTER_ASSET_V060 = "/keenetic_hero_4g_static/assets/keenetic-hero-router-v060.svg?v=1.0.14";
...
const ROOM_ASSET_V061 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v060.svg?v=1.0.14";
const ROUTER_ASSET_V061 = "/keenetic_hero_4g_static/assets/keenetic-hero-router-v060.svg?v=1.0.14";
...
const ROOM_ASSET_V062 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v062.svg?v=1.0.14";
const ROUTER_ASSET_V062 = "/keenetic_hero_4g_static/assets/keenetic-hero-router-v060.svg?v=1.0.14";
...
const ROOM_ASSET_V063 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v060.svg?v=1.0.14";
const ROUTER_ASSET_V063 = "/keenetic_hero_4g_static/assets/keenetic-hero-router-v063.webp?v=1.0.14";
...
const ROOM_ASSET_V064 = "/keenetic_hero_4g_static/assets/keenetic-hero-room-v064.webp?v=1.0.14";
...
function preloadImagesV075(root) {
  ...
  [
    "/keenetic_hero_4g_static/assets/keenetic-hero-room-v064.webp?v=1.0.14",
    "/keenetic_hero_4g_static/assets/keenetic-hero-router-v063.webp?v=1.0.14",
  ].forEach((url) => {
  ...
  return `<section class="k100-overview">
    <article class="k100-hero">
      ...
      <div class="k100-scene">
        ...
        <img class="k100-router" src="/keenetic_hero_4g_static/assets/keenetic-hero-router-v086.webp?v=1.0.14" alt="Keenetic Hero 4G+">
      </div>
    </article>
...
</style><div id="k100-shell" class="nikas-shell"><header class="k100-header nikas-shell__header"><button id="k100-menu" class="k100-side nikas-shell__side-action" type="button" aria-label="Открыть меню Home Assistant"><ha-icon icon="mdi:menu"></ha-icon></button><button id="k100-title" class="k100-title nikas-shell__title" type="button" aria-label="Вернуться на главную панель"><strong>Keenetic Hero 4G+</strong><small>UI v1.0.14</small></button><button id="k100-refresh" class="k100-side k100-refresh nikas-shell__side-action nikas-shell__side-action--right" type="button" aria-label="Обновить"><ha-icon icon="mdi:refresh"></ha-icon></button></header><main id="k100-work" class="k100-work nikas-shell__viewport" aria-label="Рабочая область панели Keenetic"><div id="k100-stage" class="k100-stage nikas-shell__canvas nikas-shell__content"></div></main><nav id="k100-tabs" class="k100-tabs nikas-shell__tabs" style="--nikas-shell-tab-count:5" aria-label="Основные разделы"></nav><div id="k100-scale-status" class="k100-scale-status" role="status" aria-live="polite">Масштаб 100%</div></div>`;
